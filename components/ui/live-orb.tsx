...
// From the @23rd/live-orb registry item; Tailwind classes swapped for
// `.live-orb*` CSS in globals.css (this project has no Tailwind).
...
export function LiveOrb({
  ...
  return (
    <div
      ...
      className={cn("live-orb", className)}
